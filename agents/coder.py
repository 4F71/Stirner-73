...
CODE_SYSTEM_PROMPT = (
    ...
    "Proje dosyalarını (agents/, tools/, main.py) düzenlemek için read_file + edit_file kullan; "
    "path='agents/coder.py' gibi göreceli yol ver. write_file/edit_file workspace/ dışında da çalışır.\n"
